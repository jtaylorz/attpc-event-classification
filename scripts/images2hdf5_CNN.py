...
#simulated protons
sim_p_filepaths = glob.glob(img_path + '/sim_p/*.png')
sim_p_inputshape = (len(sim_p_filepaths), img_width, img_height, 3)

sim_p_hdf5 = h5py.File(hdf5_path + 'sim_p.h5')
...
#simulated carbons
sim_C_filepaths = glob.glob(img_path + '/sim_C/*.png')
sim_C_inputshape = (len(sim_C_filepaths), img_width, img_height, 3)

sim_C_hdf5 = h5py.File(hdf5_path + 'sim_C.h5')
