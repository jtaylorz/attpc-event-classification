...
bottleneck_features_train_path = '../models/CNN-real2real/bottleneck_features_real2real_pC_train.npy'
bottleneck_features_test_path = '../models/CNN-real2real/bottleneck_features_real2real_pC_test.npy'
top_model_weights_path = '../models/CNN-real2real/top_model_trained_real2real_pC.h5'
