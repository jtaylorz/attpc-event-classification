...
plt.title('Single Layer NN Accuracy - p vs. C (sim and real)')
plt.ylabel('accuracy')
plt.xlabel('epoch')
plt.legend(['simulated data', 'real data'], loc='upper left')
plt.savefig('../plots/results/real/basicNN_pC_real_acc.pdf')
