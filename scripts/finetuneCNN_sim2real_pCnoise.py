"""
finetuneCNN_sim2real_pCnoise.py
===============================
...
Binary classification of protons vs. everything else
...
bottleneck_features_train_path = '../models/CNN-sim2real/bottleneck_features_sim2real_pCnoise_train.npy'
bottleneck_features_test_path = '../models/CNN-sim2real/bottleneck_features_sim2real_pCnoise_test.npy'
top_model_weights_path = '../models/CNN-sim2real/top_model_trained_sim2real_pCnoise.h5'
...
def train_top_model():
    ...
    textfile = open('../keras-results/CNN/sim2real/pCnoise.txt', 'w')
    textfile.write('acc \n')
